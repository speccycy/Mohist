...
public class UpdateUtils {
	...
	public static void versionCheck() {
		...
		try {
			JsonElement root = new JsonParser().parse(new InputStreamReader(getInput("https://ci.codemc.io/job/MohistMC/job/Mohist-1.17.1/lastSuccessfulBuild/api/json")));

			String jar_sha = MohistMCStart.getMohistVersion();
			String build_number = "1.17.1-" + root.getAsJsonObject().get("number").toString();
