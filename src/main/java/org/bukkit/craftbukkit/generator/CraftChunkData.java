...
public final class CraftChunkData implements ChunkGenerator.ChunkData {
    ...
    public Biome getBiome(int x, int y, int z) {
        ...
        return CraftBlock.biomeBaseToBiome((net.minecraft.core.Registry<net.minecraft.world.level.biome.Biome>) biomeStorage.biomeRegistry, biomeStorage.getNoiseBiome(x >> 2, y >> 2, z >> 2));
    }
