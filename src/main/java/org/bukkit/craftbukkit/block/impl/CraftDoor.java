...
public final class CraftDoor extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Door, org.bukkit.block.data.Bisected, org.bukkit.block.data.Directional, org.bukkit.block.data.Openable, org.bukkit.block.data.Powerable {
    ...
    private static final net.minecraft.state.EnumProperty<?> HINGE = getEnum(net.minecraft.world.level.block.BlockDoor.class, "hinge");
    ...
    private static final net.minecraft.state.EnumProperty<?> HALF = getEnum(net.minecraft.world.level.block.BlockDoor.class, "half");
    ...
    private static final net.minecraft.state.EnumProperty<?> FACING = getEnum(net.minecraft.world.level.block.BlockDoor.class, "facing");
