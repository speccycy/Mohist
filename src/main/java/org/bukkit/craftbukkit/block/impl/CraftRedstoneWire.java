...
public final class CraftRedstoneWire extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.RedstoneWire, org.bukkit.block.data.AnaloguePowerable {
    ...
    private static final net.minecraft.state.EnumProperty<?> NORTH = getEnum(net.minecraft.world.level.block.BlockRedstoneWire.class, "north");
    private static final net.minecraft.state.EnumProperty<?> EAST = getEnum(net.minecraft.world.level.block.BlockRedstoneWire.class, "east");
    private static final net.minecraft.state.EnumProperty<?> SOUTH = getEnum(net.minecraft.world.level.block.BlockRedstoneWire.class, "south");
    private static final net.minecraft.state.EnumProperty<?> WEST = getEnum(net.minecraft.world.level.block.BlockRedstoneWire.class, "west");
