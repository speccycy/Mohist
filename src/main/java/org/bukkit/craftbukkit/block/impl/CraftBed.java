...
public final class CraftBed extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Bed, org.bukkit.block.data.Directional {
    ...
    private static final net.minecraft.state.EnumProperty<?> PART = getEnum(net.minecraft.world.level.block.BlockBed.class, "part");
    ...
    private static final net.minecraft.state.EnumProperty<?> FACING = getEnum(net.minecraft.world.level.block.BlockBed.class, "facing");
