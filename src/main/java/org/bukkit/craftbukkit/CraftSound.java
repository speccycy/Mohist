...
public class CraftSound {
    ...
    public static SoundEvent getSoundEffect(String s) {
        SoundEvent effect = net.minecraft.util.registry.Registry.SOUND_EVENT.get(new ResourceLocation(s));
    ...
    public static Sound getBukkit(SoundEvent soundEffect) {
        return Registry.SOUNDS.get(CraftNamespacedKey.fromMinecraft(net.minecraft.util.registry.Registry.SOUND_EVENT.getKey(soundEffect)));
    }
}
